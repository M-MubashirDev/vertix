...
// import AdminProfile from "../Components/AdminDetailBar";
...
//         <div className="grid  grid-cols-2 items-center bg-gradient-to-r from-gray-100 via-white to-gray-200">
//           {/* Admin Info */}
//           <div className="flex flex-col p-8 gap-6 w-full max-w-2xl">
...
//             </div>
//           </div>
//           <div className="items-center relative bg-primary-light flex h-full">
//             <div className="absolute inset-0 bg-gradient-to-r from-primary to-transparent opacity-40"></div>{" "}
//             {/* Pattern-like gradient */}
//             <div className="absolute inset-0 grid grid-cols-2 gap-4 opacity-20">
//               {/* Optional Decorative Lines */}
//               <div className="border-l-2 border-primary-light opacity-30"></div>
//               <div className="border-r-2 border-primary-light opacity-30"></div>
//             </div>
//             <img
//               src={currentAdmin.image || "https://via.placeholder.com/150"}
//               alt={`${currentAdmin.firstname} ${currentAdmin.lastname}`}
//               className="w-40 h-40 absolute -translate-x-[50%] rounded-full border-4 border-primary shadow-lg transform transition duration-500 hover:scale-110 hover:shadow-2xl"
//             />
//           </div>
//         </div>
//       </div>
...
//               <div
//                 key={station._id}
//                 className="station-card min-w-[32rem]   bg-white  shadow-lg flex flex-col rounded-xl p-6 relative transition-transform border border-white/20"
//               >
